...
for (let i = 0; i < tab1.length ; i++){       //boucle pour appeler toutes les valeurs du tableau 1 par 1
    tab1[i]=tab1[i]/2;                        //Division d'une valeur du tableau
}

//Vérification du tab1/2
for (let i = 0 ; i < tab1.length ; i++){
    console.log(tab1[i]);
}
...
let test = [1995, 505, 1750];
console.log(test);
test.push(200);
console.log(test);
console.log(test.indexOf(200));